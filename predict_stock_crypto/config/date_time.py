...
def set_current_to_from_date() -> Union[dict[str, str], None]:
    ...
    """
    dict_date = {}
    dict_date['today'] = str(date.today().day) + '/' + str(date.today().month) + '/' + str(date.today().year)
    ...
    match day_month:
        ...
        case 1 | 2:
            dict_date['old-date'] = str(1) + '/' + str(12) + '/' + str(date.today().year-2)
            return dict_date
        case _:
            dict_date['old-date'] = str(1) + '/' + str(date.today().month) + '/' + str(date.today().year-1)
            return dict_date
